...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private final ArrayList<DataModel> contact_list = new ArrayList<DataModel>();
    ...
    public ArrayList<DataModel> Get_Contacts() {
        try {
            contact_list.clear();
    ...
    public int Update_Contact(DataModel contact) {
        SQLiteDatabase db = this.getWritableDatabase();
